...
export const EditAccount = (data) => ajax('/api/uias/v1/uias/user/center/account', 'PATCH', null, data)
...
export const SelectRoleInfo = (paths) => ajax(`/api/uias/v1/uias/roles/${paths.rid}`, 'GET')
// 创建角色 /v1/uias/roles
...
// 编辑角色 /v1/uias/roles
export const EditRole = (data) => ajax('/api/uias/v1/uias/roles', 'PATCH', null, data)


// 获取策略
export const GetPolicies = (params) => ajax('/api/uias/v1/uias/policy', 'GET', params, null)
// 查询策略详情
export const SelectPolicyInfo = (paths) => ajax(`/api/uias/v1/uias/policy/${paths.pid}`, 'GET')
// 删除策略
...
export const UnbindRoleAndUser = (data) => ajax('/api/uias/v1/uias/roles/binding/users', 'DELETE', null, data)

// 角色和策略绑定 /v1/uias/roles/binding/policies
export const RoleBindingPolicies = (data) => ajax('/api/uias/v1/uias/roles/binding/policies', 'POST', null, data)
// 角色和策略解绑 /v1/uias/roles/binding/policies
export const UnbindRoleAndPolicies = (data) => ajax('/api/uias/v1/uias/roles/binding/policies', 'DELETE', null, data)
...
export const SelectRolesFromPolicy = (paths) => ajax(`/api/uias/v1/uias/user/center/policy/${paths.policy_id}/roles`, 'GET')
...
export const SelectUserFromRole = (paths) => ajax(`/api/uias/v1/uias/user/center/role/${paths.rid}/users`, 'GET')



// 查询服务 /v1/uias/server/service
export const SelectService = () => ajax(`/api/uias/v1/uias/server/service`, 'GET')
// 查询actions {{endpoint}}/v1/uias/server/actions?service_id=e94994cb7e2c4d929e516ea593d4154d
export const SelectActions = (params) => ajax('/api/uias/v1/uias/server/actions', 'GET', params)
// 创建策略 /v1/uias/policy
export const CreatePolicy = (data) => ajax('/api/uias/v1/uias/policy', 'POST', null, data)
