...
// 删除标签 DELETE /v1/uias/user/:userId/annotation
export const DelAnnotation = (paths, data) => ajax(`/v1/uias/user/${paths.uid}/annotation`, "DELETE", null, data);
// 添加标签 POST /v1/uias/user/:userId/annotation
export const AddAnnotation = (paths, data) => ajax(`/v1/uias/user/${paths.uid}/annotation`, "POST", null, data);
