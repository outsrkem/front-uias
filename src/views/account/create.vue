                            ...
                            <el-table-column label="账号名称">
                                <template #default="scope">
                                    <el-form-item :prop="scope.$index + '.account'" :rules="fromRules.account">
                                        <el-input v-model="accountData[scope.$index].account" autocomplete="off" :placeholder="placeholder.account" ></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="用户名">
                                <template #default="scope">
                                    <el-form-item :prop="scope.$index + '.username'" :rules="fromRules.username">
                                        <el-input v-model="accountData[scope.$index].username" autocomplete="off" :placeholder="placeholder.username" ></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="邮件地址">
                                <template #default="scope">
                                    <el-form-item :prop="scope.$index + '.email'" :rules="fromRules.email">
                                        <el-input v-model="accountData[scope.$index].email" autocomplete="off" :placeholder="placeholder.email" ></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="手机号">
                                <template #default="scope">
                                    <el-form-item :prop="scope.$index + '.mobile'" :rules="fromRules.mobile">
                                        <el-input v-model="accountData[scope.$index].mobile" autocomplete="off" :placeholder="placeholder.mobile" ></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="描述">
                                <template #default="scope">
                                    <el-form-item :prop="scope.$index + '.description'">
                                        <el-input v-model="accountData[scope.$index].description" autocomplete="off" :placeholder="placeholder.describes" ></el-input>
                                    </el-form-item>
                                </template>
                            </el-table-column>
                            <el-table-column label="操作">
                                <template #default="scope">
                                    <el-button style="margin-bottom: 18px" @click="handleDeleteRow(accountData[scope.$index])" link type="primary" :disabled="delButton">删除</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-form>
    ...
    data() {
        return {
            ...
            fromRules: {
                ...
                password: [
                    { required: true, type: 'string', min:6,  message: '请输入密码，不少于6个字符', trigger: ['blur', 'change'] }
                ]
            },
            roles: [],
            ChoosingRole: [],
